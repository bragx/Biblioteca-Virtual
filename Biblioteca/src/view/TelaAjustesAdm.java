...
public class TelaAjustesAdm extends javax.swing.JFrame {

    public TelaAjustesAdm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAjustesAdm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAjustesAdm().setVisible(true);
            }
        });
    }
